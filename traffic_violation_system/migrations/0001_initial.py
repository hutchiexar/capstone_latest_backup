    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('LICENSING', 'Licensing Violations'), ('REGISTRATION', 'Registration & Accessories'), ('DIMENSION', 'Dimensions & Load Limits'), ('FRANCHISE', 'Franchise & Permits'), ('OTHER', 'Other Violations')], max_length=100)),
                ('classification', models.CharField(choices=[('REGULAR', 'Regular Violations'), ('NCAP', 'NCAP')], default='REGULAR', help_text='Classification of violation (Regular for direct tickets, NCAP for uploaded violations)', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_audience', models.CharField(choices=[('ALL', 'All Users'), ('ADMIN', 'Administrators'), ('ENFORCER', 'Traffic Enforcers'), ('SUPERVISOR', 'Supervisors'), ('TREASURER', 'Treasurers'), ('EDUCATOR', 'Educators'), ('ADJUDICATOR', 'Adjudicators'), ('USER', 'Regular Users')], default='ALL', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cttmo_seminar_certificate', models.FileField(upload_to='driver_applications/cttmo_certificates/')),
                ('xray_results', models.FileField(upload_to='driver_applications/xray_results/')),
                ('medical_certificate', models.FileField(upload_to='driver_applications/medical_certificates/')),
                ('police_clearance', models.FileField(upload_to='driver_applications/police_clearance/')),
                ('mayors_permit', models.FileField(upload_to='driver_applications/mayors_permit/')),
                ('other_documents', models.FileField(blank=True, null=True, upload_to='driver_applications/other_documents/')),
                ('submitted_at', models.DateTimeField(auto_now_add=True)),
                ('processed_at', models.DateTimeField(blank=True, null=True)),
                ('notes', models.TextField(blank=True, null=True)),
                ('processed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='processed_driver_applications', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verification_code', models.CharField(blank=True, help_text='One-time verification code sent via email', max_length=8, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('old_pd_number', models.CharField(blank=True, max_length=50, null=True, verbose_name='Old P.O. Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_pd_number', models.CharField(blank=True, max_length=20, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submitted_at', models.DateTimeField(auto_now_add=True)),
                ('processed_at', models.DateTimeField(blank=True, null=True)),
                ('extra_data', models.TextField(blank=True, help_text='JSON-encoded additional data such as number of units', null=True)),
                ('processed_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='processed_operator_applications', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('ENFORCER', 'Traffic Enforcer'), ('SUPERVISOR', 'Supervisor'), ('TREASURER', 'Treasurer'), ('EDUCATOR', 'Educator'), ('ADJUDICATOR', 'Adjudicator'), ('USER', 'Regular User')], default='USER', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_pd_number', models.CharField(blank=True, max_length=50, null=True, unique=True)),
                ('potpot_number', models.CharField(blank=True, help_text='Potpot identification number', max_length=50, null=True)),
                ('vehicle_type', models.CharField(choices=[('Jeepney', 'Jeepney'), ('Tricycle', 'Tricycle'), ('Potpot', 'Potpot'), ('Other', 'Other')], default='Tricycle', max_length=100)),
                ...
                ('capacity', models.PositiveIntegerField(blank=True, default=4, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('submission_id', models.CharField(blank=True, help_text='UUID to track violations submitted together', max_length=36, null=True)),
                ...
                ('operator_pd_number', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('ADJUDICATED', 'Adjudicated'), ('APPROVED', 'Approved'), ('REJECTED', 'Rejected'), ('PAID', 'Paid'), ('SETTLED', 'Settled'), ('CONTESTED', 'Contested'), ('HEARING_SCHEDULED', 'Hearing Scheduled'), ('DISMISSED', 'Dismissed'), ('EXPIRED', 'Expired')], default='PENDING', max_length=20)),
                ...
                ('original_violation_types', models.TextField(blank=True, help_text='Original violation types before adjudication (stored as JSON)', null=True)),
                ('original_fine_amount', models.DecimalField(blank=True, decimal_places=2, help_text='Original fine amount before adjudication', max_digits=10, null=True)),
                ('removed_violations', models.TextField(blank=True, help_text='Violations removed during adjudication with reasons (stored as JSON)', null=True)),
                ...
                ('violation_type_obj', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='violations', to='traffic_violation_system.violationtype', verbose_name='Violation Type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hash_id', models.CharField(db_index=True, max_length=64, unique=True)),
                ('first_name', models.CharField(max_length=100)),
                ('last_name', models.CharField(max_length=100)),
                ('license_number', models.CharField(blank=True, max_length=20, null=True)),
                ('phone_number', models.CharField(blank=True, max_length=15, null=True)),
                ...
                ('user_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='qr_hashes', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='violation',
            name='qr_hash',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='violations', to='traffic_violation_system.violatorqrhash'),
        ),
        migrations.CreateModel(
