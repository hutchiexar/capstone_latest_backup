# Generated by Django 5.1.6 on 2025-03-25 08:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['last_name', 'first_name'], name='traffic_vio_last_na_e862e8_idx'), models.Index(fields=['new_pd_number'], name='traffic_vio_new_pd__d09a92_idx')],
            },
        ),
        migrations.CreateModel(
            name='Driver',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['timestamp'], name='traffic_vio_timesta_fc503a_idx'), models.Index(fields=['user_profile', 'timestamp'], name='traffic_vio_user_pr_d8865a_idx')],
            },
        ),
    ]
